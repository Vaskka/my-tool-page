  ...
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <h3 className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Generate Single UUID</h3>
        <button
          onClick={generateOne}
      ...
      <div className="border-t border-slate-200 pt-6 space-y-4">
        <h3 className="text-sm font-semibold text-slate-600 uppercase tracking-wide">Generate Multiple UUIDs</h3>
      ...
      <div className="border-t border-slate-200 pt-4">
        <p className="text-xs text-slate-400">
          UUID v4 — randomly generated. Format: <code className="bg-slate-100 px-1 rounded">xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx</code>{" "}
          where <code className="bg-slate-100 px-1 rounded">y</code> is 8, 9, A, or B.
        </p>
      </div>
    </div>
  );
